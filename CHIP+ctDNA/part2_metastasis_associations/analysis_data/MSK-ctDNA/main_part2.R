...
# save the results
save(clinical_data,file="processed_data/2021/cfDNA/clinical_data.RData")
save(mutations_data,file="processed_data/2021/cfDNA/mutations_data.RData")
save(mutations,file="processed_data/2021/cfDNA/mutations.RData")
save(sv_data,file="processed_data/2021/cfDNA/sv_data.RData")
