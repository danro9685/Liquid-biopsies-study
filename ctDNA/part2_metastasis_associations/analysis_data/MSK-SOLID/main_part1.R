...
data_clinical_patient = fread(file="downloads/2017/msk_impact_2017/data_clinical_patient.txt",skip=4)
data_clinical_sample = fread(file="downloads/2017/msk_impact_2017/data_clinical_sample.txt",skip=4)
...
SUBTYPE = rep(NA,length(PATIENT_ID))
for(i in PATIENT_ID) {
...
clinical_data$METASTATIC_SITE[which(clinical_data$METASTATIC_SITE%in%c("","Not Applicable","Unknown"))] = NA
...
data_mutations_extended = fread(file="downloads/2017/msk_impact_2017/data_mutations.txt")
...
data_cna_hg19 = fread(file="downloads/2017/msk_impact_2017/data_cna_hg19.seg")
...
data_cna = fread(file="downloads/2017/msk_impact_2017/data_cna.txt")
...
data_sv = fread(file="downloads/2017/msk_impact_2017/data_sv.txt")
...
# save the results
save(clinical_data,file="processed_data/2017/clinical_data.RData")
save(mutations_data,file="processed_data/2017/mutations_data.RData")
save(mutations,file="processed_data/2017/mutations.RData")
save(cna_data,file="processed_data/2017/cna_data.RData")
save(gistic,file="processed_data/2017/gistic.RData")
save(sv_data,file="processed_data/2017/sv_data.RData")
