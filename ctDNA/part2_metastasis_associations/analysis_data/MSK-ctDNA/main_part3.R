...
data_cna_hg19 = fread(file="downloads/2022/nsclc_ctdx_msk_2022/data_cna_hg19.seg")
...
data_cna = fread(file="downloads/2022/nsclc_ctdx_msk_2022/data_cna.txt")
...
# save the results
save(clinical_data,file="processed_data/2022/Tumor/clinical_data.RData")
save(mutations_data,file="processed_data/2022/Tumor/mutations_data.RData")
save(mutations,file="processed_data/2022/Tumor/mutations.RData")
save(cna_data,file="processed_data/2022/Tumor/cna_data.RData")
save(gistic,file="processed_data/2022/Tumor/gistic.RData")
save(sv_data,file="processed_data/2022/Tumor/sv_data.RData")
