...
data_clinical_patient = fread(file="downloads/2021/msk_access_2021/data_clinical_patient.txt",skip=4)
data_clinical_sample = fread(file="downloads/2021/msk_access_2021/data_clinical_sample.txt",skip=4)
...
clinical_data = clinical_data[which(clinical_data$SAMPLE_CLASS=="Tumor"),]
...
data_mutations_extended = fread(file="downloads/2021/msk_access_2021/data_mutations.txt")
...
data_cna_hg19 = fread(file="downloads/2021/msk_access_2021/data_cna_hg19.seg")
...
cna_data = cna_data[which(cna_data$SAMPLE_ID%in%clinical_data$SAMPLE_ID),]
rownames(cna_data) = 1:nrow(cna_data)
data_cna = fread(file="downloads/2021/msk_access_2021/data_cna.txt")
genes = data_cna$Hugo_Symbol
data_cna$Hugo_Symbol = NULL
gistic = as.matrix(data_cna)
gistic = t(gistic)
colnames(gistic) = genes
gistic = gistic[sort(unique(intersect(rownames(gistic),clinical_data$SAMPLE_ID))),]
gistic = gistic[,sort(unique(colnames(gistic)))]

# process the svs data
data_sv = fread(file="downloads/2021/msk_access_2021/data_sv.txt")
...
# save the results
save(clinical_data,file="processed_data/2021/Tumor/clinical_data.RData")
save(mutations_data,file="processed_data/2021/Tumor/mutations_data.RData")
save(mutations,file="processed_data/2021/Tumor/mutations.RData")
save(cna_data,file="processed_data/2021/Tumor/cna_data.RData")
save(gistic,file="processed_data/2021/Tumor/gistic.RData")
save(sv_data,file="processed_data/2021/Tumor/sv_data.RData")
