...
data_clinical_patient = fread(file="downloads/2024/msk_ctdna_vte_2024/data_clinical_patient.txt",skip=4)
data_clinical_sample = fread(file="downloads/2024/msk_ctdna_vte_2024/data_clinical_sample.txt",skip=4)
...
clinical_data = data.frame(PATIENT_ID=PATIENT_ID,SAMPLE_ID=SAMPLE_ID,GENDER=GENDER,RACE=RACE,CANCER_TYPE=CANCER_TYPE,CANCER_TYPE_DETAILED=CANCER_TYPE_DETAILED,check.names=FALSE,stringsAsFactors=FALSE)
...
data_mutations_extended = fread(file="downloads/2024/msk_ctdna_vte_2024/data_mutations.txt")
...
data_cna = fread(file="downloads/2024/msk_ctdna_vte_2024/data_cna.txt")
...
data_sv = fread(file="downloads/2024/msk_ctdna_vte_2024/data_sv.txt")
