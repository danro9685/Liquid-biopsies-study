...
data_clinical_sample = fread(file="downloads/2020/msk_ch_2020/data_clinical_sample.txt",skip=4)
...
data_mutations_extended = fread(file="downloads/2020/msk_ch_2020/data_mutations.txt")
...
# save the results
save(clinical_data,file="processed_data/2020/clinical_data.RData")
save(mutations_data,file="processed_data/2020/mutations_data.RData")
save(mutations,file="processed_data/2020/mutations.RData")
