...
load("analysis_data/MSK-CHIP/final_data/mutations_data_2023.RData")
mutations_data = mutations_data_2023
mutations_data_2023 = NULL
...
mutations_data = mutations_data[-which(mutations_data$REF_ALLELE==mutations_data$ALT_ALLELE),]
...
data_mutations_extended = fread(file="analysis_data/MSK-CHIP/downloads/2023/msk_ch_2023/data_mutations.txt")
data_mutations_extended = data_mutations_extended[,c("Tumor_Sample_Barcode","Hugo_Symbol","Chromosome","Start_Position","End_Position","Variant_Classification","Variant_Type","Reference_Allele","Tumor_Seq_Allele2","t_alt_count","t_ref_count","HGVSp_Short")]
...
res = list()
res[["CHIP mutations"]] = mutations_data
